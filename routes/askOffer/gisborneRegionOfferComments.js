...
var Comment      = require("../../app/models/askOffer/gisborneRegionOfferComment");
...
router.get("/:comment_id/edit", askOfferMiddleware.checkGisborneRegionOfferCommentOwnership, function(req, res){
    Comment.findById(req.params.comment_id, function(err, foundComment){
        if(err){
           ...
           res.render("askOffer/gisborneRegion/offer/comments/edit", {gisborneRegionOffer_id: req.params.id, comment: foundComment}); 
        }
    });
});
