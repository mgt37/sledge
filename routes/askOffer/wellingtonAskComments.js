...
var Comment      = require("../../app/models/askOffer/wellingtonAskComment");
...
router.get("/:comment_id/edit", askOfferMiddleware.checkWellingtonAskCommentOwnership, function(req, res){
    Comment.findById(req.params.comment_id, function(err, foundComment){
        if(err){
           ...
           res.render("askOffer/wellington/ask/comments/edit", {wellingtonAsk_id: req.params.id, comment: foundComment}); 
        }
    });
});
