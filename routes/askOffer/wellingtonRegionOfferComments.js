...
var Comment      = require("../../app/models/askOffer/wellingtonRegionOfferComment");
...
router.get("/:comment_id/edit", askOfferMiddleware.checkWellingtonRegionOfferCommentOwnership, function(req, res){
    Comment.findById(req.params.comment_id, function(err, foundComment){
        if(err){
           ...
           res.render("askOffer/wellingtonRegion/offer/comments/edit", {wellingtonRegionOffer_id: req.params.id, comment: foundComment}); 
        }
    });
});
